  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 80% 60% at 50% 110%, rgba(107,78,255,0.28) 0%, transparent 70%)',
        }}
      />
      {/* Faint cyan edge top */}
      <div
        ...
        style={{ background: 'linear-gradient(to right, transparent, rgba(107,78,255,0.2), transparent)' }}
      />

      {/* CTA content */}
      <div ref={ref} className="relative z-10 flex flex-col items-center text-center px-6 pt-32 pb-24 max-w-3xl mx-auto">
        <motion.div
      ...
      >
        ...
        <span className="text-xs" style={{ color: 'rgba(255,255,255,0.12)', fontFamily: 'var(--font-body)' }}>
