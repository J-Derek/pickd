...
const STEPS = [
  {
    ...
    screenColor: '#6B4EFF',
    screenDetail: (
      <img src="/screenshots/03_pick3.png" alt="Pick 3 you love" className="w-full h-full object-cover object-top" />
    ),
  },
  {
    number: '02',
    ...
    screenColor: '#00F0FF',
    screenDetail: (
      <img src="/screenshots/04_swipe_deck.png" alt="Swipe your deck" className="w-full h-full object-cover object-top" />
    ),
  },
  {
    number: '03',
    ...
    screenColor: '#FFC107',
    screenDetail: (
      <img src="/screenshots/07_watchlist.png" alt="Watch what's actually yours" className="w-full h-full object-cover object-top" />
    ),
  },
]

function PhoneMockup({ color, children }: { color: string; children: React.ReactNode }) {
  return (
    <figure
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center">
        ...
        >
          <span className="text-xs font-bold" style={{ color: step.screenColor, fontFamily: 'var(--font-body)' }}>
            {String(index + 1).padStart(2, '0')}
          </span>
        </div>
        {/* Phone */}
        <div className="mt-4">
          <PhoneMockup color={step.screenColor}>{step.screenDetail}</PhoneMockup>
        </div>
      </div>

      {/* Right: copy */}
      <div className="pl-2 md:pl-6">
        <p className="text-xs tracking-widest uppercase mb-2 font-semibold" style={{ color: step.screenColor }}>
          Step {index + 1}
        </p>
        <h3
        ...
        <p className="text-white/45 leading-relaxed text-sm md:text-base max-w-xs" style={{ fontFamily: 'var(--font-body)' }}>
          {step.body}
        </p>
      </div>
    </motion.div>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 60% 50% at 50% 100%, rgba(107,78,255,0.08) 0%, transparent 100%)',
        }}
      />
      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          <span className="text-xs tracking-widest uppercase text-white/30 font-medium block mb-3">How it works</span>
          <h2
            id="how-heading"
        ...
        <div className="relative">
          ...
          <div
            ...
            style={{ background: 'linear-gradient(to bottom, rgba(107,78,255,0.3), rgba(0,240,255,0.15), rgba(255,193,7,0.1))' }}
          />
