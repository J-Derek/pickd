...
interface GlassButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement>, React.AnchorHTMLAttributes<HTMLAnchorElement> {
  children: ReactNode
  href?: string
  onClick?: (e: any) => void
  size?: 'sm' | 'md' | 'lg'
...
export default function GlassButton({ children, href, onClick, size = 'md', className = '', ...rest }: GlassButtonProps) {
  const sizeClasses = {
